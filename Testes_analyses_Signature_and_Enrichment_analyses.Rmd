...
save(botseqPOLsurveyedList, file="healthySpermSurveyedList.RData")
...
repTimeDensity(H9es1mb, H9es1mb_gr) %>% ggplot(aes(x=repTime, color = source)) +
  geom_density(adjust = 1/5) +
  theme_minimal() +
  scale_x_reverse() +
  xlab("<- Early             RepTime           Late ->")

repTimeDensity(Gm128781mb, Gm128781mb_gr) %>% ggplot(aes(x=repTime, color = source)) +
  geom_density(adjust = 1/5) +
  theme_minimal() +
  scale_x_reverse() +
  xlab("<- Early             RepTime           Late ->")

repTimeDensity(LCL1mb, LCL1mb_gr) %>% ggplot(aes(x=repTime, color = source)) +
  geom_density(adjust = 1/5) +
  theme_minimal() +
  scale_x_reverse() +
  xlab("<- Early             RepTime           Late ->")
