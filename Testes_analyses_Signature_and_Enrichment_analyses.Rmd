...
yo = findOverlaps(lungNormalVCF[[1]], triosSurveyed)
yo2 = findOverlaps(lungNormalVCF[[1]], triosMatSurveyed)

length(yo)/length(yo2)

sum(colonSurveyed[[4]]@ranges@width)/sum(triosMatSurveyed@ranges@width)
...
ovs<- as.data.frame(findOverlaps(VCFs,gene_gr))
