...
# Load VCF files and generate genomic ranges and other annotations
```{r}
#Load VCF files
vcf_files <- list.files("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/Inputs/All", pattern = "\\_complete_final_retained_4.goodSNPS_appended.manualFiltered.vcf$", full.names = TRUE)

#Get sample name list
sample_names <- list.files("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/Inputs/All", pattern = "\\_complete_final_retained_4.goodSNPS_appended.manualFiltered.vcf$")
sample_names <- str_remove(sample_names, "_complete_final_retained_4.goodSNPS_appended.manualFiltered.vcf")

#Get genomic regions covered in each sample. 
surveyed_files <- list.files("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Surveyed_regions", pattern = "\\.callable.bed$", full.names = TRUE)
surveyed_list <- vector(mode = "list")

for(i in sample_names){
  surveyed <- import(paste("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Surveyed_regions/",i,".callable.bed", sep=""))
...
# Create other annotation lists for each file. 
...
Tumour_Normal_tissue_info <- read.table("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/metadata/Tumour_Normal_Unmatched-WGS_analysis.Normal-Colon-Benign.txt", header=T, check.names=FALSE, sep="\t",quote = "")
...
sample_info <- read.table("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/metadata/Sample_annotation.txt", header=T, check.names=FALSE, sep="\t",quote = "")
...
PID <- factor(PID, levels=sort_order)
...
PIDTissue <- factor(PIDTissue, levels=sort_order_PIDTissue)
```

# 6 Mutation Type plots
```{r}
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_AnalysesMutPat-ByTissue-6mutTypes.png", res=300, units="in", width = 12, height=7)
plot_spectrum(type_occurrences, by = Tissue, CT = TRUE, legend = TRUE)
dev.off()

png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/MutPat-ByPIDTissue-6mutTypes.png", res=300, units="in", width = 12, height=7)
plot_spectrum(type_occurrences[1:233,], by = PIDTissue[1:233], CT = TRUE, legend = TRUE)
dev.off()

png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/MutPat-ByPIDTissue-6mutTypes_withTrioData.png", res=300, units="in", width = 12, height=7)
plot_spectrum(type_occurrences, by = PIDTissue, CT = TRUE, legend = TRUE)
dev.off()

## We decided to merge the "Normal" and "Tumour Background nomral" samples into one set. 
Tissue_Normal_TBN_merged  <- Tissue
revalue(Tissue_Normal_TBN_merged, c("Tumour_background-Normal" = "Normal")) -> Tissue_Normal_TBN_merged
revalue(Tissue_Normal_TBN_merged, c("Normal" = "Testes")) -> Tissue_Normal_TBN_merged
revalue(Tissue_Normal_TBN_merged, c("Not_normal(benign)" = "Testes(benign)")) -> Tissue_Normal_TBN_merged

#Plotting out samples separately to get the error bars.
p1 <- plot_spectrum(type_occurrences[1:233,], by = Tissue_Normal_TBN_merged[1:233], CT = TRUE, legend = FALSE)

#Plotting Just the TRIO data from RR, since it is a single file, it can not be separated into per sample. ß
p2 <- plot_spectrum(type_occurrences[234,], by = Tissue_Normal_TBN_merged[234], CT = TRUE, legend = TRUE)
p <- p1+p2+plot_layout(ncol=2,widths=c(3,1))
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/MutPat-ByTissueNormal_TBN_merged-6mutTypes_withTrioData.png", res=300, units="in", width = 12, height=5)
print(p)
dev.off()
...
## Setting the colors for each mutation type. 
...
## Generating the 96 trinucleotide matrix
mut_mat <- mut_matrix(vcf_list = vcfs, ref_genome = ref_genome)
colnames(mut_mat)


## Saving the data for future use
save(vcfs,PID,PIDTissue, Tissue,Tissue_Normal_TBN_merged,sample_names,mutational_catalog_colors, surveyed_list, file = "/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/mutational_pattern_allsamples.rds")
load("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/mutational_pattern_allsamples.rds")


# Generating 96 trinucleotide plots Per sample
for(i in colnames(mut_mat)){
  ...
  outfile <- paste("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/Per_sample_Mutational_context_plots/muta_spectrum_plot",i,".png",sep="")
...
# Generating 96 trinucleotide plots  Per Tissue ("Testes", "Colon", "Testes(Benign)", Trio_DNMs)  with 95% confidence intervals
for(i in unique(Tissue_Normal_TBN_merged)){
  ...
  outfile <- paste("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/Per_TissueType_Mutational_context_plots/muta_spectrum_plot.",i,".png",sep="")
  png(file=outfile, res=300, units="in", height = 3, width=9)
  print(p)
  dev.off()
}

# Generating 96 trinucleotide plots  Per PID  with 95% confidence intervals
for(i in unique(PID)){
  ...
  p <- ggplot(mut_mat_plot, aes(x=Context, y=mean, fill=Type)) + geom_bar(stat="identity", color="black", position=position_dodge()) + geom_errorbar(aes(ymin=mean-ci95, ymax=mean+ci95), width=.2, position=position_dodge(.9)) + facet_grid(.~Type, scales="free", space = "free") + scale_fill_manual(values=mutational_catalog_colors)+theme_pubr()+theme(legend.position="right", legend.direction="vertical", panel.spacing = unit(0, "lines"), axis.text.x = element_text(angle=90, vjust=0.5, hjust=0, size=5))+ylab("Relative Contribution") + xlab("")
  i <- str_replace(i, "/","_")
  outfile <- paste("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/Per_PID_Mutational_context_plots/muta_spectrum_plot.",i,".png",sep="")
  png(file=outfile, res=300, units="in", height = 3, width=9)
  print(p)
  dev.off()
}

# Generating 96 trinucleotide plots Per PID sparated by tissue with 95% confidence intervals
for(i in unique(PIDTissue)){
  ...
  p <- ggplot(mut_mat_plot, aes(x=Context, y=mean, fill=Type)) + geom_bar(stat="identity", color="black", position=position_dodge()) + geom_errorbar(aes(ymin=mean-ci95, ymax=mean+ci95), width=.2, position=position_dodge(.9)) + facet_grid(.~Type, scales="free", space = "free") + scale_fill_manual(values=mutational_catalog_colors)+theme_pubr()+theme(legend.position="right", legend.direction="vertical", panel.spacing = unit(0, "lines"), axis.text.x = element_text(angle=90, vjust=0.5, hjust=0, size=5))+ylab("Relative Contribution") + xlab("")
  i <- str_replace(i, "/","_")
  outfile <- paste("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/Per_PIDTissue_Mutational_context_plots/muta_spectrum_plot.",i,".png",sep="")
  png(file=outfile, res=300, units="in", height = 3, width=9)
  print(p)
  dev.off()
}

# Generating 96 trinucleotide plots Per PID with STDDEV
for(i in unique(PID)){
  rownumbers <- which(PID == i)
  mut_mat_Tmp <- mut_mat[,rownumbers]
  mut_mat_Tmp_mat <- as.matrix(mut_mat_Tmp)
  ...
  i <- str_replace(i, "/","_")
  outfile <- paste("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/Per_PID_Mutational_context_plots/muta_spectrum_plot.",i,"withSTDev.png",sep="")
  png(file=outfile, res=300, units="in", height = 3, width=9)
  print(p)
  dev.off()
}

# Generating 96 trinucleotide plots Per PID sparated by tissue with STDDEV
for(i in unique(PIDTissue)){
  rownumbers <- which(PIDTissue == i)
  mut_mat_Tmp <- mut_mat[,rownumbers]
  mut_mat_Tmp_mat <- as.matrix(mut_mat_Tmp)
  ...
  p <- ggplot(mut_mat_plot, aes(x=Context, y=mean, fill=Type)) + geom_bar(stat="identity", color="black", position=position_dodge()) + geom_errorbar(aes(ymin=mean-sd, ymax=mean+sd), width=.2, position=position_dodge(.9)) + facet_grid(.~Type, scales="free", space = "free") + scale_fill_manual(values=mutational_catalog_colors)+theme_pubr()+theme(legend.position="right", legend.direction="vertical", panel.spacing = unit(0, "lines"), axis.text.x = element_text(angle=90, vjust=0.5, hjust=0, size=5))+ylab("Relative Contribution") + xlab("")
  i <- str_replace(i, "/","_")
  outfile <- paste("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/Per_PIDTissue_Mutational_context_plots/muta_spectrum_plot.",i,"withSTDev.png",sep="")
  png(file=outfile, res=300, units="in", height = 3, width=9)
  print(p)
  dev.off()
}
...
```{r}
## Getting Genes locations from HG19 as genomicranges
genes_hg19 <- genes(TxDb.Hsapiens.UCSC.hg19.knownGene)

##Generating the trinucleotide 
...
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/Transcriptional_strand_bias_plot_ByTissue.png", res=300, units="in", width = 9, height=6)
ps1 / ps2
dev.off()
...
#effect size (log2(untranscribed/transcribed) of the strand bias
ps2 <- plot_strand_bias(strand_bias)
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/Transcriptional_strand_bias_plot_ByPIDTissue.png", res=300, units="in", width = 16, height=6)
ps1 / ps2
dev.off()
...
#effect size (log2(untranscribed/transcribed) of the strand bias
ps2 <- plot_strand_bias(strand_bias)
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/Transcriptional_strand_bias_plot_ByPIDTestes.png", res=300, units="in", width = 16, height=6)
ps1 / ps2
dev.off()
...
#effect size (log2(untranscribed/transcribed) of the strand bias
ps2 <- plot_strand_bias(strand_bias)
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/Transcriptional_strand_bias_plot_ByPIDColon.png", res=300, units="in", width = 8, height=6)
ps1 / ps2
dev.off()
...
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Enrichment_Analyses/Genomic_regions/Genic_vs_NonGenic-ByTissue.png", res=300, units="in", width = 5, height=5)
plot_enrichment_depletion(distr_test)
dev.off()

distr_test <- enrichment_depletion_test(distr, by=PIDTissue)
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Enrichment_Analyses/Genomic_regions/Genic_vs_NonGenic-ByPIDTissue.png", res=300, units="in", width = 8, height=8)
plot_enrichment_depletion(distr_test)
dev.off()
...
# Coding vs NonCoding / Exonic vs nonExonic ?
```{r}
...
write.table(coding_df,file="/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/External_Data-Code/Tissue-specific_mutation_accumulation-paper/Data/genomic_regions/Homo_sapiens.GRCh37.75_coding.bed", sep="\t", row.names = FALSE, quote = FALSE)
...
write.table(exons_hg19_df,file="/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/External_Data-Code/Tissue-specific_mutation_accumulation-paper/Data/genomic_regions/Homo_sapiens.GRCh37.75_exons.bed", sep="\t", row.names = FALSE, quote = FALSE)
...
distr_test <- enrichment_depletion_test(distr,by=Tissue_Normal_TBN_merged)
plot_enrichment_depletion(distr_test)
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Enrichment_Analyses/Genomic_regions/CTCF_Promoter_Flanking-ByTissue.png", res=300, units="in", width = 6, height=5)
plot_enrichment_depletion(distr_test)
dev.off()

distr_test <- enrichment_depletion_test(distr,by=PIDTissue)
plot_enrichment_depletion(distr_test)
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Enrichment_Analyses/Genomic_regions/CTCF_Promoter_Flanking-ByPIDTissue.png", res=300, units="in", width = 8, height=10)
plot_enrichment_depletion(distr_test)
dev.off()
```
...
save(repStrand, file="/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/repStrand.RData")

load("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/repStrand.RData")
...
plot_enrichment_depletion(distr_test)
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Enrichment_Analyses/Genomic_regions/Replication_direction-ByTissue.png", res=300, units="in", width = 6, height=5)
plot_enrichment_depletion(distr_test)
dev.off()

distr_test <- enrichment_depletion_test(gen_dist,by=PIDTissue)
plot_enrichment_depletion(distr_test)
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Enrichment_Analyses/Genomic_regions/Replication_direction-ByPIDTissue.png", res=300, units="in", width = 10, height=5)
plot_enrichment_depletion(distr_test)
dev.off()
...
```{r}
# regions bed files
regions_files = list.files("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/External_Data-Code/Tissue-specific_mutation_accumulation-paper/Data/genomic_regions", full.names = T)
print(regions_files)
# region bed files
regions_list=list()
...
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Enrichment_Analyses/Genomic_regions/enrichment_depletion-byTissue.png", width=8, height=6, res=300, units="in")
plot_enrichment_depletion(enr_depl)
dev.off()
...
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Final_Analyses/Enrichment_Analyses/Genomic_regions/enrichment_depletion-byPIDTissue.png", width=16, height=6, res=300, units="in")
plot_enrichment_depletion(enr_depl)
dev.off()
...
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Unmatched_Analysis/Plots/Rainfall_plot_normals_only-maftools.png", res=300, units="in", width = 16, height=8)
p_rainfall
dev.off()
```
...
##Early
```{r}
vcf_files_early <- list.files("/Users/rs30/volumes/rs30_lustre/Testicular_project/Unmatched_Analysis/variants_filtering-2019_12_05/Good_SNPS_Normal-Testes_only/VCF_per_ID", pattern = "\\.early.vcf$", full.names = TRUE)
sample_names <- list.files("/Users/rs30/volumes/rs30_lustre/Testicular_project/Unmatched_Analysis/variants_filtering-2019_12_05/Good_SNPS_Normal-Testes_only/VCF_per_ID", pattern = "\\.early.vcf$")
...
sample_info <- read.table("/Users/rs30/volumes/rs30_lustre/Testicular_project/Unmatched_Analysis/analysis/Sample_annotation.txt", header=T, check.names=FALSE, sep="\t",quote = "")
unique(sample_info$Annotation)
...
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Unmatched_Analysis/Plots/Mutation_type_plot-maftools.png", res=300, units="in", width = 12, height=7)
...
##Late
```{r}
vcf_files_late <- list.files("/Users/rs30/volumes/rs30_lustre/Testicular_project/Unmatched_Analysis/variants_filtering-2019_12_05/Good_SNPS_Normal-Testes_only/VCF_per_ID", pattern = "\\.late.vcf$", full.names = TRUE)
sample_names <- list.files("/Users/rs30/volumes/rs30_lustre/Testicular_project/Unmatched_Analysis/variants_filtering-2019_12_05/Good_SNPS_Normal-Testes_only/VCF_per_ID", pattern = "\\.late.vcf$")
...
## Plot Early vs Late
```{r}
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Unmatched_Analysis/Plots/Mutation_type_plot-Early_vs_late.png", res=300, units="in", width = 10, height=7)
...
png("/Users/rs30/volumes/rs30_lustre/Testicular_project/Unmatched_Analysis/Plots/Mutation_type_plot-Early_vs_late_wicoxTestwithCI.png", res=300, units="in", height=5, width=7)
