...
type_occurrences <- bind_rows(type_occurrences, trio_type_occurrences)

png("/Users/mn7/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/MutPat-ByPIDTissue-6mutTypes.png", res=300, units="in", width = 12, height=7)
...
png("/Users/mn7/volumes/rs30_lustre/Testicular_project/Final_Analyses/Unmatched_WGS/Signature_Analyses/MutPat-ByTissueNormal_TBN_merged-6mutTypes_withTrioData.png", res=300, units="in", width = 12, height=5)
print(p)
dev.off()
